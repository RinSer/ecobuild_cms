...
class SubcategoriesControllerTest < ActionController::TestCase
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post :create, subcategory: { description: @subcategory.description, image: @subcategory.image, img_url: @subcategory.img_url, title: @subcategory.title }
    end
  ...
  test "should update subcategory" do
    patch :update, id: @subcategory, subcategory: { description: @subcategory.description, image: @subcategory.image, img_url: @subcategory.img_url, title: @subcategory.title }
    assert_redirected_to subcategory_path(assigns(:subcategory))
  end
